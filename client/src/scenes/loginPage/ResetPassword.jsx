...
function ResetPassword() {
    ...
    return (
        <Box
            ...
            sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', backgroundColor: 'secondary.main' }}
        >
            <Box className="bg-white p-3 rounded w-25" sx={{ backgroundColor: 'white', p: 3, borderRadius: 1, width: '25%' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Box className="d-flex gap-2" sx={{ display: 'flex', gap: 2 }}>
                        <Button 
                            ...
                            variant="contained" 
                            fullWidth
                            sx={{ backgroundColor: '#00CFFF', '&:hover': { backgroundColor: '#00B0E0' } }}
                        >
                            Update
                        </Button>
                        <Button 
